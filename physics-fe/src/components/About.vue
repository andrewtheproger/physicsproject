<template>
  <div class="ph-about">
    <div>
      <p>Проект посвящён книге "3800 задач по физике". Цели две:
      </p>
      <ul>
    ...
    <div>
      <p>Лучше всего - добавить задачу из 3800:
      </p>
      <ul>
        <li>
     ...
     <p> Мы записываем условие в формате
      ...
      прост в освоении, основы таковы:</p>
